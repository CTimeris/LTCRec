...
# Model
################
parser.add_argument('--model_code', type=str, default='cfc')
# BERT specs, used for other models as well #
parser.add_argument('--bert_max_len', type=int, default=None)       # 序列长度
...
################
parser.add_argument('--use_ltc', type=bool, default=False)
parser.add_argument('--ode_unfolds', type=int, default=3)
